...
def main(aspect_ratio=(1280, 800), transparent=False):
    ...
    while running:
        ...
        screen.fill((0, 0, 0, 0) if transparent else (0, 0, 0))  # Transparent or black background
        ...
        if downscale == 1:
            pygame.draw.rect(screen, (0, 255, 0), (rect_left, rect_top, rect_right - rect_left, rect_bottom - rect_top), 2)
        else:
            pygame.draw.rect(screen, (255, 0, 255), (rect_left, rect_top, rect_right - rect_left, rect_bottom - rect_top), 2)
