...
public enum CameraType {
    LIMELIGHT_2(1280, 960, 2, 74.36, 13, 0.2, 0.0005, 35, 5, 0.55, 1.4175, 0.65),
    LIMELIGHT_3G(
            1280, 960, 1, 100, 8, 0.2, 0.0005, 35, 5, 0.55, 1.11574,
            0.65), // TODO: what is the actual fov of new lens we replaced
    SVPRO_GLOBAL_SHUTTER(1920, 1200, 1, 83, 23, 0.2, 0.0005, 35, 5, 0.55, 1.3, 0.65);
